...
- [ ] `dotnet build -c Release` is clean and `build/verify-single-dll.sh` passes
...
- [ ] Documentation updated where relevant (README for users, ARCHITECTURE.md for internals)
